...
const MenuPage = () => {
    ...
    return (
        <div onClick={() => setOpen(!open)}>
            ...
            {open && <div className="bg-red-500 text-white w-full absolute left-0 top-24 h-[calc(100vh-6rem)] flex flex-col items-center justify-center text-3xl gap-8 z-10">
